...
<form method="post" action="/createPsycho">
@csrf
<div class="pagetitle">
      <h1>Psychologist Form</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Users</li>
          <li class="breadcrumb-item active">Add new psychologist</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="d-flex justify-content-center mx-4 my-2">
    ...
    <input type="hidden" name="role" id="role" value="Psychologist">
