...
<div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="assets/img/hero-img.png" class="img-fluid animated" style="height: 90%;" alt="Cake">
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3>Vi's Baking Features</h3>
            <p style="font-family: 'Times New Roman', Times, serif; font-size: 17px;">
            Vi's Baking is a web applications which provide you some features to buy many products of cake, you can easily browse through our extensive cake catalog, complete with detailed descriptions and high-resolution images, making your selection a piece of cake. Customize your order with personalized messages or special dietary preferences, and our team will ensure your cake is made to perfection.
          </p>

            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon"><a href="/cake-product"><i class="bi bi-cart-plus"></i></div>
            ...
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
              <div class="icon"><a href="/consultation"><i class="bi bi-cart-check"></i></div>
              <h4 class="title">Purchased Item</a></h4>
